...
export const UserCollectionModal: React.FC<SellModalProps> = ({
      ...
      <div className="candy-sell-modal">
        {state === TransactionState.DISPLAY && (
          <div>
            ...
            <div className="candy-sell-modal-hr">
            <a href={nft.nftAnimation} download rel="noopener noreferrer" target="_blank" className="ahref">
            <button className="exchange-button-more2 btn rounded-pill mt-3 mb-1" type="button">
                  Download GLB
            </button>
            </a>
            </div>
