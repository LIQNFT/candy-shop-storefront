...
export const Nft2 = ({ nft, wallet, sellDetail, shop, candyShop }: NftProps): JSX.Element => {
  ...
  return (
    <>
      ...
      {selection && !isSellItem && (
        <SellModal2 onCancel={onClose} nft={selection} wallet={wallet} shop={shop} candyShop={candyShop} />
      )}
