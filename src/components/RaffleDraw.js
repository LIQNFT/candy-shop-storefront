   ...
   <>
     <section className="pt-5 content-eco1-bg text-sm-start">
        ...
        <div className="col-md eco-1-title">
          <p className="ai-title-home">HOMEQUBE RAFFLE DRAW <br/>
          LUCKY WINNER OF <a target="_blank"
        ...
        <div>
            ...
            <p>RAFFLE MECHANICS</p>
                <li> 1. THE RAFFLE IS OPEN TO ALL BUYERS OF OUR STRUCTURAL LEGACY NFTS, COST AT 9 SOLS. SEE OUR COLLECTION <Link to="/structural-legacies" className='link-main-color'>HERE.</Link></li>
                <li> 2. PARTICIPANTS MUST LIKE AND FOLLOW OUR TWITTER, AND INSTAGRAM ACCOUNTS.</li>
                <li> 3. CONTEST PERIOD IS FROM AUGUST 23,2022 UNTIL THE FIRST 1000 NFTS HAS BEEN SOLD.</li>
            </ul>
            <br />
            <ul style={{ listStyleType: "none" }} className="text-start">
            <p>RAFFLE DRAW</p>
                <li> 1. WINNERS WILL BE RANDOMLY GENERATED THRU AN ELECTRONIC DRAW</li>
                <li> 2. WINNERS WILL BE ANNOUNCED ON OUR SOCIAL MEDIA CHANNELS.</li>
