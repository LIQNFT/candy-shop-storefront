        ...
        <div className="container-sm conwid-25">
          <div className="">
            ...
            >
                ...
                <li className={hoveredItem === "CONTENT3" ? "list-group-item border-none on" : "list-group-item border-none on"}
...
export default NFTCollectionsOS;
