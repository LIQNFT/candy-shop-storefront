...
const MarketplaceWithFilterSA: React.FC = () => {
  ...
  return (
    <>
      <nav className="candy-orders-filter menu text-uppercase pb-3 pt-3">
        ...
        <li>
        <NavLink to="/system-architecture" className='active'>SYSTEM ARCHITECTURE</NavLink></li>
        <li>
...
export default MarketplaceWithFilterSA;
