      ...
      <div className="container content">
        <div className="container-sm conwid-25">
          <div className="">
            ...
            >
                <li className={hoveredItem === "CONTENT1" ? "list-group-item border-none on" : "list-group-item border-none"}
                    onMouseEnter={() => setHoveredItem("CONTENT1")}
                    onMouseLeave={resetHover}>
                     <Link to='/nftcollection/system-concept' className="href">SYSTEM CONCEPTS</Link>
                </li>
                <li className={hoveredItem === "CONTENT2" ? "list-group-item border-none on" : "list-group-item border-none on"}
...
export default NFTCollectionsHD;
