...
import { NftUserCollection } from '../../components/NftUserCollection';
 ...
 */
export const UserCollection: React.FC<SellProps> = ({ wallet, walletConnectComponent, style, candyShop, enableCacheNFT }) => {
